...
public class ScrollField extends JScrollPane {
    ...
    public ScrollField(Component view) {
        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }

    public ScrollField(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public ScrollField(Component view, int vsbPolicy, int hsbPolicy) {
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(ScrollField sp) {
            this.sp = sp;
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            pane.getStyledDocument().insertString(0, "Kevin", null);
        ...
        frame.add(new ScrollField(pane));
